...
class TrackingSampler_MS(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        train_frames, train_anno, meta_obj_train, ms_label_train = dataset.get_frames(seq_id, train_frame_ids, seq_info_dict)
        test_frames, test_anno, meta_obj_test, ms_label_test = dataset.get_frames(seq_id, test_frame_ids, seq_info_dict)
        ...
        data = TensorDict({'train_images': train_frames,
                           ...
                           'ms_label_train':ms_label_train,
                           'ms_label_test':ms_label_test})

        return self.processing(data)

class DiMPSampler_MS(TrackingSampler_MS):
    """ See TrackingSampler_MS."""
