...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler_MS([rgbnir_train,rgbnirplus_train], [1,1],
    ...
    dataset_val = sampler.DiMPSampler_MS([rgbnir_val,rgbnirplus_val], [1,1], samples_per_epoch=5000, max_gap=30,
    ...
    lrgain = 1e-1
    # Optimizer
    optimizer = optim.Adam([{'params': actor.net.classifier.filter_initializer.parameters(), 'lr': lrgain*5e-5},
