...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler([rgbnir_train,rgbnirplus_train], [1,1],
    ...
    dataset_val = sampler.DiMPSampler([rgbnir_val,rgbnirplus_val], [1,1], samples_per_epoch=settings.val_samples_per_epoch,
    ...
    optimizer = optim.AdamW([
        {'params': actor.net.head.parameters(), 'lr': lrw*1e-4},
        {'params': actor.net.feature_extractor.layer3.parameters(), 'lr': lrw*2e-5}
