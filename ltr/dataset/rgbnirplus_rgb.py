...
class RGBNIRPLUS_RGB(BaseVideoDataset):
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, data_fraction=None):
        self.root = env_settings().rgbnirplus_rgb_dir if root is None else root
        super().__init__('RGBNIRPLUS_RGB', root, image_loader)
