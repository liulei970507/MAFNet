...
class Head(nn.Module):
    """
    """
    def __init__(self, filter_predictor, feature_extractor, classifier, bb_regressor,transformer_branch,
    ...
    def forward(self, train_feat, test_feat, train_bb, *args, **kwargs):
        ...
        train_feat = self.transformer_branch(train_feat, train_pos)
        test_feat = self.transformer_branch(test_feat, test_pos)
        #pdb.set_trace()
