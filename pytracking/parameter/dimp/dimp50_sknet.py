...
def parameters():
    ...
    # params.net_path='/DATA/liulei/RGBNIR/DiMP/ltr/checkpoints/ltr/dimp/dimp50_stage2_nobias_cbam_3_fix/DiMPnet_ep0050.pth.tar' #RGBNIR
    # params.net_path='/home/liulei/zhutianhao/DIMP/ltr/checkpoints/ltr/dimp/dimp50_stage2_nobias_sknet_one_stage/DiMPnet_ep0050.pth.tar' #RGBNIR one stage
    # params.net_path='/home/liulei/zhutianhao/DIMP/ltr/checkpoints/ltr/dimp/dimp50_stage2_nobias_sknet_RGBT_2/DiMPnet_ep0004.pth.tar' #RGBT
    # params.net_path = '/DATA/liulei/RGBNIR/DiMP/ltr/checkpoints/ltr/dimp/dimp50_stage2_sknet_dimpmodel/DiMPnet_ep0050.pth.tar' #RGBNIR
    params.net_path = '/DATA/liulei/RGBNIR/DiMP/ltr/checkpoints/ltr/dimp/dimp50_stage2_nobias_sknet_fix/DiMPnet_ep0050.pth.tar'
    params.net = NetWithBackbone(net_path=params.net_path,
