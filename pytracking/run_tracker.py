...
def main():
    ...
    # 20 dimp50_ms_morep_bn_rgbnir_easy
    # 21 dimp50_ms_morep_bn_rgbnir_hard
    # 22 dimp50_ms_morep_bn_rgbnir_all
    
    parser.add_argument('--runid', type=int, default=22501, help='The run id.') 
    parser.add_argument('--dataset_name', type=str, default='rgbnirplus', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
