...
dataset_dict = dict(
    ...
    rgbnirplus=DatasetInfo(module=pt % "rgbnirplus", class_name="RGBNIRPLUSDataset", kwargs=dict()),
    # rgbnirval=DatasetInfo(module=pt % "rgbnirval", class_name="RGBNIRVALDataset", kwargs=dict()),
    rgbtval=DatasetInfo(module=pt % "rgbtval", class_name="RGBTVALDataset", kwargs=dict()),
